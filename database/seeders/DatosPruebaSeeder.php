...
class DatosPruebaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ══════════════════════════════════════
        $pedidos = [
            ['folio' => 'PED-2025-089', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-001', 'nombre' => 'Resina epóxica', 'cantidad' => 500, 'precio' => 85]], 'total' => 42500.00, 'tipo_pago' => 'credito', 'estatus' => 'entregado', 'notas' => 'Entregado sin novedad', 'created_at' => '2025-11-15'],
            ['folio' => 'PED-2025-102', 'codigo_cliente' => 'CLI-2026-002', 'nombre_cliente' => 'Ferretería López', 'codigo_proveedor' => '102003241', 'nombre_proveedor' => 'Materiales Industriales del Bajío', 'productos' => [['sku' => 'SAL-003', 'nombre' => 'Solvente técnico', 'cantidad' => 200, 'precio' => 42.5]], 'total' => 8500.00, 'tipo_pago' => 'contado', 'estatus' => 'entregado', 'notas' => null, 'created_at' => '2025-12-03'],
            ['folio' => 'PED-2026-008', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-001', 'nombre' => 'Resina epóxica', 'cantidad' => 600, 'precio' => 85], ['sku' => 'SAL-005', 'nombre' => 'Pigmento', 'cantidad' => 100, 'precio' => 120]], 'total' => 63000.00, 'tipo_pago' => 'credito', 'estatus' => 'entregado', 'notas' => null, 'created_at' => '2026-01-10'],
            ['folio' => 'PED-2026-021', 'codigo_cliente' => 'CLI-2026-002', 'nombre_cliente' => 'Ferretería López', 'codigo_proveedor' => '102003241', 'nombre_proveedor' => 'Materiales Industriales del Bajío', 'productos' => [['sku' => 'SAL-007', 'nombre' => 'Catalizador', 'cantidad' => 50, 'precio' => 210]], 'total' => 10500.00, 'tipo_pago' => 'contado', 'estatus' => 'entregado', 'notas' => 'Recogido en planta', 'created_at' => '2026-02-05'],
            ['folio' => 'PED-2026-035', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-001', 'nombre' => 'Resina epóxica', 'cantidad' => 750, 'precio' => 85], ['sku' => 'SAL-003', 'nombre' => 'Solvente', 'cantidad' => 300, 'precio' => 42.5]], 'total' => 76500.00, 'tipo_pago' => 'credito', 'estatus' => 'enviado', 'notas' => 'Guía Estafeta: 6024958372615', 'created_at' => '2026-03-12'],
            ['folio' => 'PED-2026-048', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-001', 'nombre' => 'Resina epóxica', 'cantidad' => 800, 'precio' => 85]], 'total' => 68000.00, 'tipo_pago' => 'credito', 'estatus' => 'procesando', 'notas' => 'En producción lote #4521', 'created_at' => '2026-04-02'],
            ['folio' => 'PED-2026-055', 'codigo_cliente' => 'CLI-2026-002', 'nombre_cliente' => 'Ferretería López', 'codigo_proveedor' => '102003242', 'nombre_proveedor' => 'Juan Pérez López', 'productos' => [['sku' => 'SAL-005', 'nombre' => 'Pigmento', 'cantidad' => 80, 'precio' => 120]], 'total' => 9600.00, 'tipo_pago' => 'contado', 'estatus' => 'validacion', 'notas' => 'Pendiente verificar stock', 'created_at' => '2026-04-15'],
            ['folio' => 'PED-2026-061', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-011', 'nombre' => 'Fibra de refuerzo', 'cantidad' => 20, 'precio' => 320], ['sku' => 'SAL-009', 'nombre' => 'Aditivo antioxidante', 'cantidad' => 100, 'precio' => 55]], 'total' => 11900.00, 'tipo_pago' => 'credito', 'estatus' => 'procesando', 'notas' => null, 'created_at' => '2026-04-20'],
            ['folio' => 'PED-2026-068', 'codigo_cliente' => 'CLI-2026-002', 'nombre_cliente' => 'Ferretería López', 'codigo_proveedor' => '102003241', 'nombre_proveedor' => 'Materiales Industriales del Bajío', 'productos' => [['sku' => 'SAL-015', 'nombre' => 'Sellador industrial', 'cantidad' => 30, 'precio' => 95]], 'total' => 2850.00, 'tipo_pago' => 'contado', 'estatus' => 'validacion', 'notas' => null, 'created_at' => '2026-04-25'],
            ['folio' => 'PED-2025-075', 'codigo_cliente' => 'CLI-2026-001', 'nombre_cliente' => 'Comercializadora del Norte SA de CV', 'codigo_proveedor' => '102003240', 'nombre_proveedor' => 'Distribuidora Nacional SA de CV', 'productos' => [['sku' => 'SAL-013', 'nombre' => 'Adhesivo estructural', 'cantidad' => 40, 'precio' => 180]], 'total' => 7200.00, 'tipo_pago' => 'credito', 'estatus' => 'cancelado', 'notas' => 'Cancelado — cambio de especificación', 'created_at' => '2025-10-20'],
        ];
