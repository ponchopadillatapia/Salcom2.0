...
@section('area-title', 'Material de Empaque')
@section('hero')
...
<style>
    ...
    .badge-cat{font-size:10px;font-weight:600;padding:3px 10px;border-radius:6px;background:var(--purple-light);color:var(--purple)}
...
<div class="kpis">
    <div class="kpi"><div class="kpi-val" style="color:var(--purple)">{{ $total }}</div><div class="kpi-label">Materiales</div></div>
...
<div class="card">
    <div class="card-head">Inventario de Material de Empaque</div>
    @if($productos->count())
    <table class="tbl">
    ...
    @else
    <div class="empty">No hay materiales de empaque registrados</div>
    @endif
</div>
