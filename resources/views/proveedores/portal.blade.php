...
<div class="portal-body">
    ...
    <div class="top-grid">
        ...
        <div class="card"><h4>Pagos programados</h4><div class="stat-val">—</div><div class="stat-label">Pendiente de API</div></div>
    ...
    {{-- MIDDLE: Calendar + Activity + Onboarding --}}
    <div class="mid-grid">
        <div class="card">
    ...
    {{-- BOTTOM: Quick access --}}
    <div class="top-grid" style="grid-template-columns: repeat(3,1fr);">
