...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-header .icon-wrap svg { width: 26px; height: 26px; }
        .card-header h2 {
            font-family: 'Playfair Display', serif;
            font-size: 22px;
...
<div class="main">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="icon-wrap">
                <svg viewBox="0 0 24 24" fill="none" stroke="#6B3FA0" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <form method="POST" action="{{ route('proveedores.registro.guardar') }}">
            ...
            <div class="form-row">
                <div class="field" style="margin-bottom:0">
                    ...
                    <input type="tel" name="telefono" placeholder="33 1234 5678"
        ...
        <p class="login-link">
            ¿Ya tienes cuenta? <a href="{{ route('proveedores.login') }}">Inicia sesión aquí</a>
        </p>
