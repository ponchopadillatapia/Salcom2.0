<div class="sidebar" id="appSidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('proveedores.inventario') }}" data-tip="Inventario"
        ...
        @php $portalOk = $proveedorPortalActivo ?? true; @endphp
        <a href="{{ $portalOk ? route('proveedores.fiscal') : route('proveedores.onboarding') }}" data-tip="Fiscal"
           class="sb-link {{ request()->routeIs('proveedores.fiscal') ? 'active' : '' }}" @if(! $portalOk) style="opacity:.45" title="Completa onboarding" @endif>
            <div class="sb-icon">
        ...
        <a href="{{ route('proveedores.dashboard') }}" data-tip="Facturas"
           class="sb-link">
            <div class="sb-icon">
